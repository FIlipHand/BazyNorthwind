...
--
-- Name: pkcategories; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY categories
    ADD CONSTRAINT pkcategories PRIMARY KEY (categoryid);


--
-- Name: pkcustomercustomerdemo; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY customercustomerdemo
    ADD CONSTRAINT pkcustomercustomerdemo PRIMARY KEY (customerid, customertypeid);


--
-- Name: pkcustomerdemographics; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY customerdemographics
    ADD CONSTRAINT pkcustomerdemographics PRIMARY KEY (customertypeid);


--
-- Name: pkcustomers; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY customers
    ADD CONSTRAINT pkcustomers PRIMARY KEY (customerid);


--
-- Name: pkemployees; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY employees
    ADD CONSTRAINT pkemployees PRIMARY KEY (employeeid);


--
-- Name: pkemployeeterritories; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY employeeterritories
    ADD CONSTRAINT pkemployeeterritories PRIMARY KEY (employeeid, territoryid);


--
-- Name: pkorderdetails; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY orderdetails
    ADD CONSTRAINT pkorderdetails PRIMARY KEY (orderid, productid);


--
-- Name: pkorders; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT pkorders PRIMARY KEY (orderid);


--
-- Name: pkproducts; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY products
    ADD CONSTRAINT pkproducts PRIMARY KEY (productid);


--
-- Name: pkregion; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY region
    ADD CONSTRAINT pkregion PRIMARY KEY (regionid);


--
-- Name: pkshippers; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY shippers
    ADD CONSTRAINT pkshippers PRIMARY KEY (shipperid);


--
-- Name: pksuppliers; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--
...
--
-- Name: pkterritories; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY territories
    ADD CONSTRAINT pkterritories PRIMARY KEY (territoryid);


--
-- Name: pkusstates; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--

ALTER TABLE ONLY usstates
    ADD CONSTRAINT pkusstates PRIMARY KEY (stateid);


--
-- Name: fkorderscustomers; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT fkorderscustomers FOREIGN KEY (customerid) REFERENCES customers;


--
-- Name: fkordersemployees; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT fkordersemployees FOREIGN KEY (employeeid) REFERENCES employees;


--
-- Name: fkordersshippers; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT fkordersshippers FOREIGN KEY (shipvia) REFERENCES shippers;


--
-- Name: fkorderdetailsproducts; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY orderdetails
    ADD CONSTRAINT fkorderdetailsproducts FOREIGN KEY (productid) REFERENCES products;


--
-- Name: fkorderdetailsorders; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY orderdetails
    ADD CONSTRAINT fkorderdetailsorders FOREIGN KEY (orderid) REFERENCES orders;


--
-- Name: fkproductscategories; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY products
    ADD CONSTRAINT fkproductscategories FOREIGN KEY (categoryid) REFERENCES categories;


--
-- Name: fkproductssuppliers; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY products
    ADD CONSTRAINT fkproductssuppliers FOREIGN KEY (supplierid) REFERENCES suppliers;


--
-- Name: fkterritoriesregion; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY territories
    ADD CONSTRAINT fkterritoriesregion FOREIGN KEY (regionid) REFERENCES region;


--
-- Name: fkemployeeterritoriesterritories; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY employeeterritories
    ADD CONSTRAINT fkemployeeterritoriesterritories FOREIGN KEY (territoryid) REFERENCES territories;


--
-- Name: fkemployeeterritoriesemployees; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY employeeterritories
    ADD CONSTRAINT fkemployeeterritoriesemployees FOREIGN KEY (employeeid) REFERENCES employees;


--
-- Name: fkcustomercustomerdemocustomerdemographics; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY customercustomerdemo
    ADD CONSTRAINT fkcustomercustomerdemocustomerdemographics FOREIGN KEY (customertypeid) REFERENCES customerdemographics;


--
-- Name: fkcustomercustomerdemocustomers; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY customercustomerdemo
    ADD CONSTRAINT fkcustomercustomerdemocustomers FOREIGN KEY (customerid) REFERENCES customers;


--
-- Name: fkemployeesemployees; Type: Constraint; Schema: -; Owner: -
--

ALTER TABLE ONLY employees
    ADD CONSTRAINT fkemployeesemployees FOREIGN KEY (reportsto) REFERENCES employees;
